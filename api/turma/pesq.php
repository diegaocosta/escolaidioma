<?php
    ...
    // var_dump($_POST);
    $query = "select turma.id as id, turma.nome as turma, semana, curso.nome as curso, funcionario.nome as professor from curso, funcionario, turma where turma.idfun = funcionario.id and turma.idcurso = curso.id and cargo = 1";
    switch (intval($tipo))
    {
