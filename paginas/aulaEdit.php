...
<body class="central" onload="init()">
    ...
    ?>
    <form action="../api/aula/edit.php" method="post" name="form" class="box">
        <div class="titulo">Editar Aula</div>
        <div class="conteudo">
    ...
    <div class="btngrupo">
        ...
        <button type="button" class="direita2" onclick="enviar()">Editar</button>
        <!-- <input class="direita2"  type="submit" value="Logar"> -->
    </div>
<script src="../js/validadores.js"></script>
<script src="../js/mask.js"></script>
<script src="../js/aula/edit.js"></script>
    <?php
