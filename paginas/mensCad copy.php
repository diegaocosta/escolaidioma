    ...
    <form action="../api/mens/cad.php" method="post" name="form" class="box">
        ...
        <div class="conteudo" id="mens">
            <div class="size1 sizes">
                <div>
                    <input type="text" id="alunopesq"  placeholder="clique para escolher um aluno ou digite para pesquisar aluno" onclick="mostrar()" onkeyup="pesquisar()">
                    <div id="alunolist"></div>
                </div>
            </div>
            <div class="size1 sizes">
                <div>                    
            ...
            <div class="size3 sizes">
                <div>                    
                    <label >Total:</label>
                    <input type="text" maxlength="8" id="valororiginal" name="valororiginal">
                </div>
                <div>                    
