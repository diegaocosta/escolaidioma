...
<body class="central" onload="init()">
    ...
    ?>
    <form action="../api/mate/edit.php" method="post" name="form" class="box">
        <div class="titulo">Editar Material</div>
        <div class="conteudo">
            ...
            <div class="size2 sizes">
                ...
                <div>
                    ...
                    <input type="text" maxlength="8"  id="valor" name="valor" placeholder="Informe o valor">
                </div>
            </div>
            <div class="size2 sizes">
                <div>
...
<script src="../js/mate/edit.js"></script>
    <?php
